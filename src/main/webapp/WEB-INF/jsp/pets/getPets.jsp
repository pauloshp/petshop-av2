...
<html>
    ...
    <body>
        ...
        <div class="container" align="center">
            ...
            <a class="btn btn-primary ml-2" href="${path}/pets/new"><i class="fas fa-plus"></i> Inserir um novo pet</a>
                ...
                <tbody>
                  <c:forEach var="pet" items="${petList}">
                    <tr>
                      ...
                      <td>${pet.raca}</td>
                      <td>
                          <a class="btn btn-warning btn-sm float-left" href="${path}/pets/id/${pet.id}"><i class="fas fa-edit"></i></a>
